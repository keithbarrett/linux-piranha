...
**
** 9/11/2000	1.23	Philip Copeland <copeland@redhat.com>
...
**
** 5/31/2001    1.25    Keith Barrett <kbarrett@redhat.com>
...
enum lvsBackupMode { LVS_BACKUP_MODE_UNKNOWN = 0,
             LVS_BACKUP_MODE_BACKUP = 1, LVS_BACKUP_MODE_SWITCH = 2};

enum lvsRedirectionType { LVS_REDIRECT_UNKNOWN = 0,
              LVS_REDIRECT_NAT, LVS_REDIRECT_DIRECT, 
                  LVS_REDIRECT_TUNNEL };

enum lvsSchedulers { LVS_SCHED_UNKNOWN = 0,
             LVS_SCHED_LC, LVS_SCHED_RR, LVS_SCHED_WLC, 
             LVS_SCHED_WRR };

enum lvsServiceTypes { LVS_SERVICE_TYPE_LVS = 0, LVS_SERVICE_TYPE_FOS };
